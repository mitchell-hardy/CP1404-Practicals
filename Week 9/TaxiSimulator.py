"""
CP1404/CP5632 Practical - Taxi Simiulator
"""
...
class SilverServiceTaxi(Taxi):
    ...
    def get_fare(self):
        """ get the price for the taxi trip """
        return self.special_price_per_km * self.current_fare_distance + self.flagfall

    def __str__(self):
        return"{}, {}km on current fare, ${:.2f}/km plus flagfall of ${:.2f}."\
            .format(super().__str__(), self.current_fare_distance,
                    self.special_price_per_km, self.flagfall)
